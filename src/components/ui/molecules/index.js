...
export { default as PostAuthorBar } from './PostAuthorBar/PostAuthorBar.component';
export { default as SideNavigation } from './SideNavigation/SideNavigation.component';
export { default as SinglePostDetails } from './SinglePostDetails/SinglePostDetails.component';
